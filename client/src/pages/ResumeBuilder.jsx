...
import { ArrowLeftIcon, Briefcase, BriefcaseIcon, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2Icon, ShareIcon, Sparkles, SparklesIcon, User } from 'lucide-react'
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-visible'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              {/*progress bar using activeSelectionIndex*/}
