...
import { Layout, Check } from 'lucide-react' // adjust if you use a different icon library
...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        <Layout size={14} /> <span className="max-sm:visible">Template</span>
      </button>

      {isOpen && (
        <div className="absolute top-full mt-2 z-50 p-3 space-y-3 bg-white rounded-md border border-gray-200 shadow-sm w-64">
